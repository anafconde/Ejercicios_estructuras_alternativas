...
if n_alum>=100:
    costo=(n_alum*65)+4000
    print(f"El coste de organización del viaje de estudios para {n_alum} alumnos + el autobús es de: {costo} €")
    pago=costo/n_alum
    print(f"Cada alumno deberá pagar un total de {pago} €")
elif n_alum>=50 and n_alum<=99:
    costo=(n_alum*70)+4000
    print(f"El coste de organización del viaje de estudios para {n_alum} alumnos + el autobús es de: {costo} €")
    pago=costo/n_alum
    print(f"Cada alumno deberá pagar un total de {pago} €")
elif n_alum>=30 and n_alum<=49:
    costo=(n_alum*95)+4000
    print(f"El coste de organización del viaje de estudios para {n_alum} alumnos + el autobús es de: {costo} €")
    pago=costo/n_alum
    print(f"Cada alumno deberá pagar un total de {pago} €")
elif n_alum>=0 and n_alum<=29:
    #falta un dato en el enunciado, creo
    costo=(n_alum)+4000
    print(f"El coste de organización del viaje de estudios para {n_alum} alumnos + el autobús es de: {costo} €")
    pago=costo/n_alum
    print(f"Cada alumno deberá pagar un total de {pago} €")
